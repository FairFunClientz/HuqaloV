...
public interface DiscordRPCextends Library
{
    ...
    void Discord_Initialize(@Nonnull String paramString1, @Nullable DiscordEventHandlers paramDiscordEventHandlers,
            boolean paramBoolean, @Nullable String paramString2);
